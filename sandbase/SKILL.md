...
9. **Confirm external side effects** — obtain explicit user confirmation before any call that sends messages, publishes content, changes accounts, purchases resources, or performs another destructive or externally visible action.

**Credit:** Based on the [SandBase CLI MCP workflow](https://github.com/sandbaseai/cli/tree/main/assets/skills/sandbase).
