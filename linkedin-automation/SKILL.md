...
description: General-purpose LinkedIn automation through Linked API. Use when the user wants to fetch profiles, search people and companies, send messages, manage connections, create posts, or interact with LinkedIn.
---
