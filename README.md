...
- [PGYER (蒲公英)](https://github.com/PGYER/pgyer-skill) - Official skill from [PGYER](https://www.pgyer.com) (since 2014, leading Chinese app beta-distribution platform). Upload iOS/Android/HarmonyOS builds for beta testing; ships CI/CD templates (GitHub Actions, GitLab CI). Cross-agent via the open Skills CLI (`npx skills add PGYER/pgyer-skill -a <agent>`); pairs with the official MCP server [`PGYER/pgyer-mcp-server`](https://github.com/PGYER/pgyer-mcp-server). *By [PGYER](https://github.com/PGYER)*
