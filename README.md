...
- [flops-compute-prices](https://github.com/zeroatflops/flops-skill) - Look up and cite verifiable GPU/compute rental reference prices (spot, on-demand, DePIN) from the public FLOPS Index. Price → verify → cite, key-free. *By [@zeroatflops](https://github.com/zeroatflops)*
