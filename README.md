...
- [freshman](https://github.com/evanhan1995/claude-freshman-skill) - Beginner-friendly project workflow orchestrator: `/freshman new` chains idea-refine→grill-me→spec→prototype→incremental-impl→review→handoff, `/freshman fix` chains diagnose→incremental-impl→review. Auto-advances with user confirmation at key gates. *By [@evanhan1995](https://github.com/evanhan1995)*
