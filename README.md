...
- [crowd-test](https://github.com/anhhuyn411-alt/crowd-test) - Unleashes a mob of AI virtual-user personas (impatient shoppers, seniors, keyboard-only users, chaos monkeys) on a website in real browsers, then grades whether it survived; findings are cross-verified by up to three independent harnesses. *By [@anhhuyn411-alt](https://github.com/anhhuyn411-alt)*
