...
- [Sendmux Agent Skills](https://github.com/Sendmux/skills) - Sendmux email, mailbox, CLI, MCP, and workflow skills for AI coding agents. *By [Sendmux](https://github.com/Sendmux)*
