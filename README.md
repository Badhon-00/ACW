...
- [scorm](https://github.com/studiolxd/scorm-skills) - Teaches agents to use @studiolxd/scorm, a headless SCORM 1.2/2004 runtime (React, Vue, Angular, Svelte, Web Component, vanilla).
