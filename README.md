...
- [resume-claude-session](https://github.com/travcjohnson/claude-skills) - Recovers a lost Claude Code session when `claude --resume` fails with "No conversation found" by locating the session file across all project directories and extracting the real working directory. *By [@travcjohnson](https://github.com/travcjohnson)*
