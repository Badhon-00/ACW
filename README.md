...
- [UI Review](https://github.com/cdmx-in/ui-review) - Automated UI/UX review via the agent-browser CLI: text overflow, wrapping, responsiveness across breakpoints, dark mode, WCAG zoom/reflow, codebase-mapped fixes, and a token-saving baseline/diff regression mode. *By [@cdmx-in](https://github.com/cdmx-in)*
