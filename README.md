...
- [Facebook Ads Library MCP](https://github.com/proxy-intell/facebook-ads-library-mcp) - Search Meta's public ad library for any brand, pull the ads they're running right now, and analyze image and video creative with Gemini. Batch tools compare messaging across several competitors in one pass; hosted version available at [useproxy.dev](https://useproxy.dev/) if you'd rather skip API keys. *By [@proxy-intell](https://github.com/proxy-intell)*
- [Google Ads Library MCP](https://github.com/proxy-intell/google-ads-library-mcp) - Queries Google's Ads Transparency Center by company domain for live text, image, and video ads, including every headline/description variation and region-level impression stats. Same creative-analysis tooling as its Facebook counterpart. *By [@proxy-intell](https://github.com/proxy-intell)*
