...
- [AI Delivery Spec](https://github.com/franklinxkk/ai-delivery-spec) - Product-side spec-driven delivery framework: PRD, prototype, DDD/API/data contract, acceptance gates, AI runtime governance, and coding-agent handoff. 4 domain modules (CRM, traffic safety, education IT, medical/hospital IT). *By [@franklinxkk](https://github.com/franklinxkk)*
