...
- [claude-skills-doctor](https://github.com/gulmezeren2-byte/claude-skills-doctor) - Whole-system health check for installed Claude Code agent skills: measures the 15,000-character discovery budget (over which Claude Code silently stops listing skills), validates frontmatter, and flags name/folder mismatches, duplicate names, colliding descriptions, and risky skill scripts. *By [@gulmezeren2-byte](https://github.com/gulmezeren2-byte)*
