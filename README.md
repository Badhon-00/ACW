...
- [liustack](https://github.com/liustack/liustack) - The lighter, stronger Superpowers alternative: four skills, one closed loop (shape it, code it, dig it, snapshot it). Eval-verified behavior, measured context cost, bilingual. *By [@liustack](https://github.com/liustack)*
