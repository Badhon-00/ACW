...
- [JobYap](https://github.com/jobyap/agent-skills) - Search job postings aggregated from companies' official careers sites — salaries, locations, and a community discussion thread on every job. *By [@jobyap](https://github.com/jobyap)*
