...
- [make-new-things](https://github.com/minxnnu-cloud/make-new-things) - Division-of-labor pipeline skills for dual Claude+Codex users: visuals (prompt writing included) go to Codex, facts/copy/approvals stay with Claude, plus styleframe-first approval gates and rework budgets mined from a 52-round revision audit. *By [@minxnnu-cloud](https://github.com/minxnnu-cloud)*
