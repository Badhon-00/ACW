...
- [gh-attach](https://github.com/sudosubin/gh-attach) - A GitHub CLI (gh) extension and agent skill to upload and download GitHub user-attachments (screenshots, PDFs, zips, videos) from the terminal, producing github.com/user-attachments URLs that work in issues, PRs, and READMEs. Supports GitHub Enterprise Server, concurrent uploads, and Markdown or JSON output. *By [@sudosubin](https://github.com/sudosubin)*
