...
- [Polish Legal AI Skills](https://github.com/matematicsolutions/awesome-matematic-skills-pl) - Skill pack for Polish law: LLM output validation pipeline (router, grounding, adversarial review, audit bundle), offline PII anonymization with PESEL/NIP/REGON/KRS checksum validation, SAOS case law search, EUR-Lex SPARQL, native Word Track Changes for .docx, and AI Act art. 12 audit bundles. GDPR-aware throughout. Apache-2.0 / MIT per skill. *By [@matematicsolutions](https://github.com/matematicsolutions)*
