...
- [fluiddocs-deck-builder](./fluiddocs-deck-builder/) - Builds single-file, type-correct HTML decks from a one-line brief, with PDF and PPTX import and inline editing.
