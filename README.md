...
- [Shipwright](https://github.com/nhattrung0911/shipwright) - 5 composable, portable skills that make AI agents plan, build, secure & operate software like a senior engineer (OWASP Top 10:2025, full-stack, SRE). For Claude Code, Codex & Gemini.
