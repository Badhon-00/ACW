...
- [Git Pull Rebase Trap](https://github.com/MrBinnacle/skills/tree/main/skills/engineering/git-pull-rebase-trap) - Stops `git pull` from silently rebasing and rewriting your local commits when `pull.rebase=true` is configured; born from a real incident that rewrote 22 commits. *By [@MrBinnacle](https://github.com/MrBinnacle)*
