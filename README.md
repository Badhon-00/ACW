...
- [fullstack-ts-scaffold](https://github.com/shaantanu9/fullstack-ts-scaffold) - Regenerates a production-shaped full-stack TypeScript monorepo (Next.js 15 client, Express API with three swappable database backends, JWT rotating-refresh auth, background worker, PWA, tests, and CI) and verifies it builds green in ~1-3 min. *By [@shaantanu9](https://github.com/shaantanu9)*
