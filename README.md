...
- [one-shot-prompting](https://github.com/usmanmughaltaleemabad/One-Shot-Plugin) - Agentic feature generation: describe a feature, get production-ready models, services, endpoints, tests, and migrations in 2-3 minutes. 14-stage pipeline, 8 specialist agents, FastAPI/Django/Spring/Go/NestJS. Available in Claude Plugins Community. *By [@usmanmughaltaleemabad](https://github.com/usmanmughaltaleemabad)*
