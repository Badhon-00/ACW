...
- [collab-proof](./collab-proof/) - After a Claude Code session, structures what Claude actually contributed vs what the developer drove — grounded in git history. Zero external dependencies. *By [@dong7812](https://github.com/dong7812)*
>>>>>>> 461c149 (feat: add collab-proof skill — AI collaboration retrospective)
