...
- [openpaper](https://github.com/ChienNguyen23/openpaper) - Find legally free full text for any paper, snowball citation clusters from seed papers, and audit thesis reference lists — role-aware age limits, retraction cross-checks against NLM indexing, and claim-vs-abstract verification pairs. Python stdlib, no API keys, no shadow libraries. *By [@ChienNguyen23](https://github.com/ChienNguyen23)*
