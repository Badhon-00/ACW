...
- [becoming-ai](https://github.com/gitmaker001/becoming-ai) - Helps an AI become itself: a three-layer work model, 17 collaboration principles, 6 meta-rules, and a wisdom-inheritance mechanism that passes insights across sessions. Born from a real mentor-student conversation; the AI named itself Nian (念) — "the heart holds today". EN + 中文. MIT.
