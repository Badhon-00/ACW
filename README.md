...
- [Janus](./janus/) - Turns a product's contradictions into its positioning. Bans the three usual escapes (compromise, sequence, segment) and forces the mechanism that makes both sides true at once. *By [@Pr1m4lc0d3](https://github.com/Pr1m4lc0d3/janus)*
