...
- [second-mind](https://github.com/RohitYadav34980/second-mind/tree/master) - Builds and maintains a living Obsidian-compatible technical wiki for your codebase — scans code, git history, and configs, captures decisions, and generates high-fidelity database, auth, API, deployment, and workflow guides so full project context is restored at every session start. *By [@rohityadav](https://github.com/rohityadav34980)*
