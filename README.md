...
- [safedeps](https://github.com/Jeneidi/safedeps) - Grounds dependency choices in live OSV.dev/CVE data so your AI agent stops suggesting known-vulnerable package versions. Skill + PreToolUse hook, stdlib-only, no API key. *By [@Jeneidi](https://github.com/Jeneidi)*
