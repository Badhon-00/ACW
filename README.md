...
- [remote-gpu-trainer](https://github.com/Hanyuyuan6/remote-gpu-trainer) - Deploy, train, monitor, and tear down long GPU jobs on rented/remote instances (AutoDL, RunPod, vast.ai, Lambda, Slurm, bare SSH), with billing/teardown safety, spot resilience, and disk budgeting. *By [@Hanyuyuan6](https://github.com/Hanyuyuan6)*
