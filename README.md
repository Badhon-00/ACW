...
- [html-animation-to-mp4](https://github.com/AZR-Software-Solutions/html-animation-to-mp4) - Renders an HTML/CSS/JS animation — especially a Claude “Design” timeline artifact (.dc.html) — into a frame-perfect MP4 via headless-Chromium frame capture + ffmpeg. Auto-detects size/duration; deterministic virtual-clock mode for generic JS/canvas/CSS too. CLI + Claude skill. *By [@AZR-Software-Solutions](https://github.com/AZR-Software-Solutions)*
