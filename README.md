...
- [llm-box](https://github.com/alib8b8/llm-box) - Terminal-first workflow automation engine. Generate and execute YAML workflows from plain English descriptions. Features 20+ built-in nodes, 15+ LLM providers (Ollama, DeepSeek, OpenAI-compatible), and MCP server mode for integration with Claude Code, Grok, and other AI coding agents. *By [@alib8b8](https://github.com/alib8b8)*
