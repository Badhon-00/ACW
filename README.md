...
- [Staff Engineer Mode](https://github.com/sirmarkz/staff-engineer-mode) - Major-outage lessons for engineering work. One Claude Code plugin router sends architecture, reliability, security, delivery, and operations prompts to 54 specialist references. *By [@sirmarkz](https://github.com/sirmarkz)*
