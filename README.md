...
- [Web Security Patterns](./web-security-patterns/) - Auto-detects web features and injects security patterns for auth, APIs, file uploads, database queries, payments, and secrets. *By [@mrhlaingbwardev](https://github.com/mrhlaingbwardev)*
