...
- [code-humanizer](https://github.com/LeonardNJU/code-humanizer) - Removes AI-generated code slop via a 16-pattern catalog (duplicated helpers, try-import fallbacks, broad excepts, single-implementation abstractions) with test-gated, behavior-preserving fixes. *By [@LeonardNJU](https://github.com/LeonardNJU)*
