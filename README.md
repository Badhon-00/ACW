...
- [open-code-review](https://github.com/alibaba/open-code-review/tree/main/skills/open-code-review) - AI-powered code review CLI (`ocr`) that reads Git diffs and produces structured, line-level review comments with optional auto-fix. Combines deterministic file/rule selection with an agent for high-precision reviews at ~1/9 the tokens of general-purpose agents. *By [@alibaba](https://github.com/alibaba)*
