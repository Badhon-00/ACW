...
- [doc-janitor](https://github.com/holydement0r/doc-janitor) - Tidies project documentation safely: consolidates scattered progress files, reports, and notes, generates or merges CLAUDE.md and README, and archives stale files instead of deleting them. *By [@holydement0r](https://github.com/holydement0r)*
