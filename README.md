...
- [ckw-design](https://github.com/connerkward/ckw-design-skill) - Frontend design skill that gives Claude a consistent design direction, a reusable design system, and a visual philosophy so generated UI stops reading as AI slop. *By [@connerkward](https://github.com/connerkward)*
...
- [deterministic-design](https://github.com/connerkward/deterministic-design-skill) - Renders your UI and proves it's balanced and usable: a deterministic layout audit plus a vision-model-judged usability pass, so design quality becomes a check rather than a vibe. *By [@connerkward](https://github.com/connerkward)*
...
- [lookdev](https://github.com/connerkward/lookdev-studio-skill) - Stands up a live, human-in-the-loop web studio with sliders and pickers to tune AI-generated visual output by eye, then bakes the chosen values into reproducible assets. *By [@connerkward](https://github.com/connerkward)*
- [lookdev-auto](https://github.com/connerkward/lookdev-auto-skill) - Automated visual tuning: a vision model rates rendered variants in a loop and suggests better parameter values, for when "looks right" is the success criterion and there's no numeric metric. *By [@connerkward](https://github.com/connerkward)*
...
- [macos-screen-recorder](https://github.com/connerkward/macos-screen-recorder-system-audio) - Headless macOS screen recorder that captures the display plus system audio via ScreenCaptureKit — no BlackHole/loopback driver and no sudo, just the standard Screen Recording permission. CLI-scriptable. *By [@connerkward](https://github.com/connerkward)*
- [screenstudio-alternative](https://github.com/connerkward/screenstudio-alternative-skill) - Open-source, headless Screen Studio alternative for screen recordings: auto-zoom on click clusters, idle speed-up, keystroke overlays, and 9:16 vertical export that follows the action. *By [@connerkward](https://github.com/connerkward)*
- [Slack GIF Creator](./slack-gif-creator/) - Creates animated GIFs optimized for Slack with validators for size constraints and composable animation primitives.
- [Theme Factory](./theme-factory/) - Applies professional font and color themes to artifacts including slides, docs, reports, and HTML landing pages with 10 pre-set themes.
- [Video Downloader](./video-downloader/) - Downloads videos from YouTube and other platforms for offline viewing, editing, or archival with support for various formats and quality options.
- [web-media-getter](https://github.com/connerkward/web-media-getter-skill) - One query across free image, video, and GIF APIs (Pexels, NASA, Openverse, Klipy, and more) returning license-tagged results, so Claude can pull real or archival media instead of generating it. *By [@connerkward](https://github.com/connerkward)*
