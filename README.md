...
- [go-agent-skills](https://github.com/eduardo-sl/go-agent-skills) - 28 curated Go skills covering code review, concurrency safety, error handling, testing, gRPC, and architecture. Built on the Uber Go Style Guide and Effective Go. *By [@eduardo-sl](https://github.com/eduardo-sl)*
