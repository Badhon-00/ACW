...
- [Dashmotion](https://github.com/csthink/dashmotion) - Turns a description or a Mermaid source into a self-contained animated technical diagram — one HTML file, pure SVG/CSS, no JavaScript, with connectors that flow and request dots travelling through the system. *By [@csthink](https://github.com/csthink)*
