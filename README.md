...
- [claude-repo-audit](https://github.com/Joopinhontas/claude-repo-audit) - Grades any Git repo: secret-leak scan (real leaks vs demo fixtures), hygiene, maintainability, and a Vibe Score for how much a codebase reads as unreviewed AI-generated code. Ships an SVG scorecard badge. *By [@Joopinhontas](https://github.com/Joopinhontas)*
