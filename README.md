...
- [humanizer-ru](https://github.com/ilyautov/humanizer-ru) - Rewrites Russian AI-generated text into natural prose: 52 patterns across 12 categories, 20 hard bans, voice calibration, plus an audit mode with a deterministic offline scanner.
