...
- [OneQuery](https://github.com/wordbricks/skills/tree/main/skills/onequery-cli) - CLI skill for safe, auditable agent queries against approved data sources. *By [@wordbricks](https://github.com/wordbricks)*
