...
- [MiniMax Text to Speech](./minimax-text-to-speech/) - Converts text into natural speech using the MiniMax text-to-speech API with the speech-2.8-hd model family, synchronous HTTP, asynchronous and realtime WebSocket synthesis, global and China regions, and mp3/wav/flac/pcm output.
