...
- [auteur](https://github.com/agiwhitelist/auteur) - Directs a website like a film: art direction committed before any markup, assets generated by local CLIs, and two executable gates — an anti-slop linter and a throttled-CPU motion check — that fail the build on the AI-default gradient, `transition: all`, scroll-listener animation and dropped frames. Nine live showcase sites, all passing. *By [@agiwhitelist](https://github.com/agiwhitelist)*
