...
- [skill-intake](https://github.com/Tingtao-code/skill-intake) - Vets a candidate skill, MCP, or prompt before you adopt it: checks overlap with skills you already have, fit, weight/distillation, and safety, then runs a one-shot install. *By [@Tingtao-code](https://github.com/Tingtao-code)*
