...
- [experience-database](https://github.com/opahimmel/experience-database) - Greppable knowledge database (.xp/db.jsonl) that persists what an agent already learned about a codebase across sessions, plus @xp:slug markers linking code to stored insights. *By [@opahimmel](https://github.com/opahimmel)*
