...
- [SandBase](https://github.com/sandbaseai/cli/tree/main/assets/skills/sandbase) - Discover, inspect, and safely run 2,000+ AI models and API tools through one MCP workflow, with schema-first execution, cost awareness, async polling, and error handling. *By [@sandbaseai](https://github.com/sandbaseai)*
