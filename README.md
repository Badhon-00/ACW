...
- [GitHub Image Hosting](./github-image-hosting/) - Upload images to img402.dev and embed them in GitHub PRs, issues, and comments. No account or API key needed — one curl command. Free tier (1MB, 7-day) plus optional x402-paid tiers for 1-year ($0.01) or permanent ($1) retention.
