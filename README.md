...
- [GeoAI Skills](https://github.com/muend/geoai-skills) - 18 skills for geospatial and remote-sensing work: CRS-safe data engineering, spectral analysis, spatial statistics, PostGIS, Earth Engine, LiDAR, and cartography, with explicit refusal conditions for spatial leakage, processing-level mismatches, and unsupportable change claims. Publishes its routing benchmark including a documented defect. *By [@muend](https://github.com/muend)*
