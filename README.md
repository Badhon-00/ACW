...
- [Code Analyzer Suite](./code-analyzer-suite/) - Parallel multi-dimensional code analysis: Security, Performance, Code Quality, Architecture, and Logic Verification. *By [@Alex-eng-ux](https://github.com/Alex-eng-ux)*
- [Code Analyzer Auto](./code-analyzer-suite/code-analyzer-auto/) - Automatically dispatches multi-dimensional code review to sub-agents and consolidates findings into one report. *By [@Alex-eng-ux](https://github.com/Alex-eng-ux)*
...
- [Parallel Decomposer](./parallel-decomposer-skill/) - Decompose complex tasks into parallel subtasks for multi-agent execution. *By [@Alex-eng-ux](https://github.com/Alex-eng-ux)*
- [Parallel Decomposer Auto](./parallel-decomposer-skill/parallel-decomposer-auto/) - Converts complex requests into orchestration-ready worker specs for automatic sub-agent or worker-thread dispatch. *By [@Alex-eng-ux](https://github.com/Alex-eng-ux)*
