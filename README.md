...
- [seedance-2-5-skill](https://github.com/AtlasCloudAI/awesome-seedance-2.5-prompts-skills/tree/main/skills/seedance-2-5-skill) - Plans and generates controllable Seedance video, using Seedream 5.0 Pro storyboard frames to lock character and product consistency, with reference-to-video and first-and-last-frame control, shipped alongside a library of 150+ Seedance 2.5 prompts. *By [@AtlasCloudAI](https://github.com/AtlasCloudAI)*
