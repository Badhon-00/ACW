...
- [creativity](https://github.com/BislanB/claude-skills-ru/tree/main/skills/creativity) - Pushes Claude off the statistically-average answer: bans the obvious default, finds the TRIZ contradiction, reframes the problem, and collides distant domains to deliver one non-obvious solution with its trade-off. *By [@BislanB](https://github.com/BislanB)*
...
- [humanizer-ru](https://github.com/BislanB/claude-skills-ru/tree/main/skills/humanizer-ru) - Turns robotic AI-generated Russian text into natural, living prose: strips bureaucratese, fixes sentence rhythm (burstiness), and adds an authorial voice. Built on the classics of Russian editorial style (Nora Gal, Maxim Ilyahov). *By [@BislanB](https://github.com/BislanB)*
