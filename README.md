...
- [overhaul-ui](https://github.com/ShadowFull12/overhaul-ui) - Frontend design skill that detects and defers to specialist skills (animation, anti-slop, colour), with WCAG 2.2, OKLCH and 35-rule slop-detection scripts for what none of them ship. *By [@ShadowFull12](https://github.com/ShadowFull12)*
