...
- [Despacho de Plantão](./despacho-plantao/) - Drafts the on-duty police chief's dispatch decision for Brazilian judicial police from a narrated incident: assesses the arrest situation, classifies the offense, and lists numbered follow-up measures. Written in Brazilian Portuguese. *By [@andrevictor23-tech](https://github.com/andrevictor23-tech)*
