...
- [design-regression-guard](https://github.com/Yuxiang-Ma/agent-skills/tree/main/plugins/research-kit/skills/design-regression-guard) - Turns every fixed visual defect class (contrast, touch targets, type scale, overflow, drawn-ink-vs-readout) into a Playwright assertion in the same commit, so design fixes cannot silently regress; distilled from sessions where the guard caught its own author twice. *By [@Yuxiang-Ma](https://github.com/Yuxiang-Ma)*
...
- [measured-design-audit](https://github.com/Yuxiang-Ma/agent-skills/tree/main/plugins/research-kit/skills/measured-design-audit) - Reviews web design by measurement instead of eyeballing: computed WCAG contrast against composited backgrounds, 44 px touch targets, font-size and tracking censuses, and multi-viewport overflow, with color fixes solved numerically for the minimum passing shift. *By [@Yuxiang-Ma](https://github.com/Yuxiang-Ma)*
