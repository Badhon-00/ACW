...
- [MUNDO — THE EMPEROR](https://github.com/LiHongwei-cn/lihongwei-cn) - Self-evolving AI skill engine for Claude Code & Hermes Agent. Consults ALL AIs (ChatGPT, Claude, Gemini, DeepSeek), crawls GitHub/SO/docs, saves solutions as reusable Skills with Three Departments & Six Ministries hierarchy. Parallel sub-agents, collective consciousness, infinite growth. Multilingual (EN/CN/JP/KR). *By [@LiHongwei-cn](https://github.com/LiHongwei-cn)*
