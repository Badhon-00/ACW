...
- [multi-stack-mcp](https://github.com/VovikP/multi-stack-mcp) - One MCP, every stack — generates native UI sections (hero, pricing, features, CTA) for Next.js, Flutter, WordPress, and Vue from a unified pattern catalog with shared design tokens. Ships token + slot denylist, atomic safe-write, symlink refuse. *By [@VovikP](https://github.com/VovikP)*
