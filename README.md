...
- [Dependency Change Reviewer](./dependency-change-reviewer/) - Reviews dependency manifest and lockfile changes for compatibility, security, and migration risk with explicit approval outcomes.
