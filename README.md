...
- [squirrelscan](https://github.com/squirrelscan/squirrelscan/tree/main/skills) - Audits a website for SEO, performance, security, accessibility, and agent experience issues (260+ rules) and returns exact fixes to your coding agent, then drives an audit-then-fix loop. Install with `npx skills add squirrelscan/squirrelscan`. *By [@squirrelscan](https://github.com/squirrelscan)*
