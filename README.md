...
- [skill-doctor](https://github.com/ssamba1/skill-doctor) - Audits your installed Claude Code skill library: per-turn context cost of always-on skill descriptions, never-fired skills (from transcript history), trigger collisions, duplicates, and reversible disable-model-invocation fixes; also flags unused MCP servers. *By [@ssamba1](https://github.com/ssamba1)*
