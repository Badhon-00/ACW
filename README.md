...
- [shelf-skills](https://github.com/Ranveersingh1113/shelf-skills) - Turns saved links into a searchable markdown library and surfaces the right one mid-task. Notes are indexed by the problem they solve, and recall says "nothing in your library covers this" rather than padding out weak matches. *By [@Ranveersingh1113](https://github.com/Ranveersingh1113)*
