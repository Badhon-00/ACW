...
- [Claude Code Skills Starter](https://github.com/claudifytech/claude-code-skills-starter) - A free, MIT-licensed starter set of Claude Code skills: conventional commits, code review, test writing, and README generation, plus a starter CLAUDE.md. *By [@claudifytech](https://github.com/claudifytech)*
