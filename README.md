...
- [Lumify](https://github.com/lumifyai/awesome-claude-skills/tree/lumify-skill/lumify) - Hosted sports intelligence MCP: schedules, live scores, sportsbook odds, public betting splits, and explainable bet confidence. *By [@lumifyai](https://github.com/lumifyai)*
