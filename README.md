...
- [seedance-prompts-skill](https://github.com/mantoufan/seedance-prompts-skill) - Turns a one-line idea or a novel into a full 50-100 episode short-drama screenplay, then converts it into copy-paste-ready Seedance 2.0 video prompts and timeline storyboards through a progressive command flow (`/start /plan /characters /outline /episode /review /compliance /export`). Bilingual (中文/English). *By [@mantoufan](https://github.com/mantoufan)*
