...
- [coco](https://github.com/rkz91/coco) - 389-expert advisory board (9 teams) with optional `--debate` deliberation before attributed verdicts; ships 146 skills, 277 commands, and multi-agent orchestration for Claude Code, Cursor, and Codex. MIT. *By [@rkz91](https://github.com/rkz91)*
