...
- [mobile-web-app](https://github.com/meursyphus/ssgoi/tree/latest/plugins/ssgoi/skills/mobile-web-app) - Applies SSGOI's native app-like routed page transitions to existing mobile web apps by following its canonical framework and layout guides. *By [@meursyphus](https://github.com/meursyphus)*
