...
- [Bilig WorkPaper](./bilig-workpaper/) - Work with formula-backed WorkPaper JSON in agent workflows, including cell edits, recalculation, and readback verification. *By [@proompteng](https://github.com/proompteng)*
