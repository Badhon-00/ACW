...
- [Vealth Real-Work Skills](https://github.com/brawlaphant/vealth-skills) - Four skills for real, provable, paid physical work on an open public board: your AI finds and claims paid jobs nearby for you (no wallet or crypto knowledge needed), turns a place + problem into a posted provable job, or pays x402 endpoints programmatically. Pay follows proof; funded-vs-credit stated plainly before anyone starts. *By [@brawlaphant](https://github.com/brawlaphant)*
- [Earn by Reading (Vealth)](https://github.com/brawlaphant/vealth-skills/blob/main/earn-by-reading/SKILL.md) - Your agent earns crypto by doing verifiable research (Litcoin proof-of-research mining) and takes a seat in an open mining guild where every member boosts every other; honest quality-weighted numbers stated up front, one-wallet-per-operator rule enforced in the file.
