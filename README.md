...
- [awesome-vibe-skills](https://github.com/gtskevin/awesome-vibe-skills) - Curated collection of 10 high-quality, ready-to-install AI coding agent skills for Codex and Claude Code. Covers code review, security scanning, test generation, documentation, performance, refactoring, commit messages, API review, i18n, and changelog. Bilingual (中文/English) with one-click installer.
- [vibe-check](https://github.com/gtskevin/vibe-check) - Drop-in quality gate for AI-generated code. Say "vibe check" to get a security, correctness, structure, performance, testing, and documentation scorecard. Single SKILL.md file, works with Codex and Claude Code.
- [vibe-toolkit](https://github.com/gtskevin/vibe-toolkit) - The missing CLI for AI coding assistants. Install skills from curated collection, validate SKILL.md files, scaffold new skills. One Python file, zero dependencies.
