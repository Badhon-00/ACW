...
- [skills-janitor](https://github.com/khendzel/skills-janitor) - Audit, usage-track, and prune installed skills — always-loaded vs on-demand token costs, and a swipe-to-delete TUI. Zero dependencies, Claude Code + Codex. *By [@khendzel](https://github.com/khendzel)*
