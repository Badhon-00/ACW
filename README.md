...
- [faf-skills](https://github.com/Wolfe-Jam/faf-skills) - A curated set of Claude Code skills (open SKILL.md format) that author, score, and sync a project's persistent .faf context, so Claude reads an accurate, up-to-date codebase picture. *By [@Wolfe-Jam](https://github.com/Wolfe-Jam)*
