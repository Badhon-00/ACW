...
- [flutter-smoke-auto](https://github.com/ceeyang/flutter-smoke-auto) - Automated smoke testing for Flutter apps (Android/iOS/Web): derives user journeys from source, generates Maestro flows and Playwright specs from a shared selector contract, triages and self-heals failures, and ships framework-agnostic integrity gates that block AI agents from weakening tests. *By [@ceeyang](https://github.com/ceeyang)*
