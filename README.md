...
- [GodPrompt](https://github.com/AKzar1el/god-prompt) - The universal engineering skill that auto-detects task type and applies production-grade workflow. Inspired by [AKzar1el](https://github.com/AKzar1el).
