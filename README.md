...
- [simple-man](https://github.com/Maksim-Burtsev/simple-man) - Strips praise, recaps and filler from agent answers while keeping every fact you act on: findings carry their location and one-line fix, refusals carry the safe procedure, and tutorials stay long-form. Benchmarked on 1,793 preregistered live calls with raw records committed. *By [@Maksim-Burtsev](https://github.com/Maksim-Burtsev)*
