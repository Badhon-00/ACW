...
- [eskill](https://github.com/hedralab/eskill) - Meta-skill to build top-tier Agent Skills: interview, market & insight research, one-page plan, numbered-file pipeline, eval loop, validator, commercialization checklist. *By [@hedralab](https://github.com/hedralab)*
