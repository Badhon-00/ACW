...
- [doc-router](https://github.com/1nsaneeee/doc-router) - Two-stage documentation query routing: Context7 coarse lookup locates the docs URL, then llms.txt / source-repo deep read for ground truth, with a fallback chain. *By [@1nsaneeee](https://github.com/1nsaneeee)*
