...
- [Embedded/IoT Mentor](https://github.com/mh-mansouri/embedded-iot-mentor) - Picks the MCU, board, and toolchain for an embedded/IoT project and hands you a build plan to a working breadboard, with cost/time estimates and circuit-design guidance. *By [@mh-mansouri](https://github.com/mh-mansouri)*
