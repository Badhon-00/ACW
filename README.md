...
- [rule-audit](https://github.com/xniperbuilds/rule-audit) - Audits your CLAUDE.md and settings to show which rules are actually enforced and which are only advisory, then converts the enforceable ones into hooks and permission rules. *By [@xniperbuilds](https://github.com/xniperbuilds)*
