...
- [LLM Observer](./llm-observer/) - Complete audit, optimization, and documentation workflow for any LLM observability platform (Helicone, LangSmith, Langfuse, Braintrust, W&B Weave, Phoenix/Arize). Log review, cost/latency analysis, prompt optimization with real data, and Claude Code prompt generation across 7 structured modules. *By [@migetech](https://github.com/migetech)*
