...
- [lazy-cat](https://github.com/albertobarnabo/lazy-cat) - Two-skill plugin that stops Claude from hardcoding data a library already has and from adding code nobody asked for — a strategy check before implementation and a scope check before each code block. *By [@albertobarnabo](https://github.com/albertobarnabo)*
