...
- [ebb-ai](https://www.ebb-ai.com) - Defers any "do it later" / "by tomorrow" / "overnight" task to the cleanest electricity-grid hour inside a deadline. 40-70% lower CO2 per task, 50% cheaper via Anthropic/OpenAI Batch APIs. 9 MCP tools, per-task carbon receipts, Apache-2.0. *By [@Vitalini](https://github.com/Vitalini)*
