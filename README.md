...
- [OneQuery](https://github.com/wordbricks/skills/tree/main/skills/onequery-cli) - CLI skill for safe, auditable queries for agents against approved data sources. *By [@wordbricks](https://github.com/wordbricks)*
