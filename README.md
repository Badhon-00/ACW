...
- [FutureSearch SDK](https://github.com/futuresearch/futuresearch-python/tree/main/skills/futuresearch-python) - Run AI web research agents on every row of a dataframe, plus intelligent operations like semantic deduping, fuzzy merging, qualitative ranking, and screening. *By [@futuresearch](https://github.com/futuresearch)*
