...
- [brainstorming](https://github.com/rudi193-cmd/willow-2.0/blob/master/willow/fylgja/skills/brainstorming.md) - Structured brainstorm before plan or implementation — search context first, three approaches, recommend one, stop until confirmed. *By [@rudi193-cmd](https://github.com/rudi193-cmd)*
...
- [debugging](https://github.com/rudi193-cmd/willow-2.0/blob/master/willow/fylgja/skills/debugging.md) - Systematic bug hunt — search prior context, fix surgically, never ship without a test. *By [@rudi193-cmd](https://github.com/rudi193-cmd)*
- [external-guard](https://github.com/rudi193-cmd/willow-2.0/blob/master/willow/fylgja/skills/external-guard.md) - Scan and wrap untrusted external content before LLM passes — prompt-injection defense with sandwich framing. *By [@rudi193-cmd](https://github.com/rudi193-cmd)*
...
- [investigate](https://github.com/rudi193-cmd/willow-2.0/blob/master/willow/fylgja/skills/investigate.md) - Combined brainstorm + debug framework — structured thinking before building or fixing. *By [@rudi193-cmd](https://github.com/rudi193-cmd)*
- [iterative-retrieval](https://github.com/rudi193-cmd/willow-2.0/blob/master/willow/fylgja/skills/iterative-retrieval.md) - Context retrieval ladder — memory, grep, section read, docs, full file last. *By [@rudi193-cmd](https://github.com/rudi193-cmd)*
...
- [learn](https://github.com/rudi193-cmd/willow-2.0/blob/master/willow/fylgja/skills/learn.md) - Extract reusable patterns from work into linked notes so the next session doesn't rediscover them. *By [@rudi193-cmd](https://github.com/rudi193-cmd)*
...
- [review](https://github.com/rudi193-cmd/willow-2.0/blob/master/willow/fylgja/skills/review.md) - Fork-aware code review checklist — tests, security, placeholders, patterns before merge. *By [@rudi193-cmd](https://github.com/rudi193-cmd)*
- [rober-rules](https://github.com/rudi193-cmd/willow-2.0/blob/master/willow/fylgja/skills/rober-rules.md) - Ten Applied Reality Engineering rules for when you've gone too far or are guessing instead of measuring. *By [@rudi193-cmd](https://github.com/rudi193-cmd)*
