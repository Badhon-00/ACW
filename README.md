...
- [frontend-slides](https://github.com/dreamid27/frontend-slides) - Creates animation-rich HTML presentations from a prompt or by converting PowerPoint files, using 88 layout presets and 34 template design systems to produce a single self-contained HTML file with no build step. Works in Claude Code and other coding agents. *By [@dreamid27](https://github.com/dreamid27)*
