...
- [entroly](https://github.com/juyterman1000/entroly) - An auditable context control plane that compresses prompt context (70–95%), stabilizes cache prefixes for KV-cache discounts, and verifies answers locally with WITNESS hallucination guard. Works as a Claude Code skill. *By [@juyterman1000](https://github.com/juyterman1000)*
