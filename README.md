...
- [claude-carbon](https://github.com/gwittebolle/claude-carbon) - Tracks the carbon footprint of Claude Code sessions: live CO2 in the status line, plus `carbon-report` and `carbon-card` skills for per-model reports and shareable PNG cards (EN/FR). *By [@gwittebolle](https://github.com/gwittebolle)*
