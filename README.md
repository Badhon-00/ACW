...
- [clerk-skills](https://clerk.com/docs/guides/ai/skills) - Clerk's skills for adding auth to an app, covering framework setup, custom UI, and backend integration.
