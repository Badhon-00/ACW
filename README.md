...
- [pm-agent](https://github.com/facukoren/pm-agent) - Senior PM agent that turns a feature idea into a codebase-grounded PRD — discovery interview, testable FR/NFR, dependency- and risk-aware roadmap — then optionally implements it epic by epic with test-first, adversarially verified agents. *By [@facukoren](https://github.com/facukoren)*
