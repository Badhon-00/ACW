...
- [SwapTitan MCP](https://swaptitan.net/mcp) - Crypto swap skill for Claude. Swap 1288+ assets (BTC→XMR, ETH→SOL), live prices, portfolio check, rug analysis, AI chat. No KYC. x402 micropayments.
