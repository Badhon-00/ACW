...
- [internalcot](https://github.com/morluto/internalcot) - Makes agent reasoning visible as persistent working notes throughout a Claude Code or Codex conversation using an opt-in skill and local CLI. Install with `npx internalcot@latest setup`. *By [@morluto](https://github.com/morluto)*
