...
- [Competitor Teardown](https://github.com/tracetify/skills/tree/main/skills/competitor-teardown) - Turns a competitor's real growth history into a dated, source-linked playbook, then applies it to your own project. Reads 12-source growth traces via the tracetify-mcp server (first mentions, backlink waves, traffic history, community archives) and refuses to guess when data is missing. *By [@tracetify](https://github.com/tracetify)*
