...
- [multi-llm-plugin](https://github.com/beastlabai/multi-llm-plugin) - Multi-LLM orchestration plugin for Claude Code: parallel plan review, task generation, implementation, and code review across 12 coding harnesses (Codex, Cursor, opencode, pi, aider, Antigravity…). *By [@beastlabai](https://github.com/beastlabai)*
