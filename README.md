...
- [humanize-text-skill](https://github.com/lynote-ai/humanize-text-skill) - Bilingual zh/en writing skill that detects AI-shaped prose, rewrites safely, and pulls output toward a target human voice. *By [@fendouai](https://github.com/fendouai)*
