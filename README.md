...
- [entroly](https://github.com/juyterman1000/entroly) - Local-first MCP context tools for explicit-budget evidence selection, content-addressed exact recovery, and auditable Context Receipts. Works with Claude Code through MCP. *By [@juyterman1000](https://github.com/juyterman1000)*
