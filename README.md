...
- [CoinPaprika API](https://github.com/coinpaprika/skills/tree/main/coinpaprika-api) - Query crypto market data for 12,000+ coins and 350+ exchanges. Tickers, OHLCV, historical prices, contract lookups. Free tier, no API key required. *By [@coinpaprika](https://github.com/coinpaprika)*
- [CSV Data Summarizer](https://github.com/coffeefuelbump/csv-data-summarizer-claude-skill) - Automatically analyzes CSV files and generates comprehensive insights with visualizations without requiring user prompts. *By [@coffeefuelbump](https://github.com/coffeefuelbump)*
- [DexPaprika API](https://github.com/coinpaprika/skills/tree/main/dexpaprika-api) - Query DEX data across 36 blockchains. 36M+ pools, 33M+ tokens, 230+ DEXes, SSE streaming, OHLCV, search. Free tier, no API key required. *By [@coinpaprika](https://github.com/coinpaprika)*
