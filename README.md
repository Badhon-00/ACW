...
- [mobile-web-app](https://github.com/meursyphus/ssgoi/tree/latest/plugins/ssgoi/skills/mobile-web-app) - Applies SSGOI's router-agnostic drill, sheet, slide, and zoom page transitions to React, Svelte, Vue, Solid, Angular, and Qwik mobile web apps. [Docs and live demos](https://ssgoi.dev). *By [@meursyphus](https://github.com/meursyphus)*
