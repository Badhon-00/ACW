...
- [delta-engage](https://github.com/newan2001/delta-engage) - Finds high-fit Reddit & LinkedIn posts to engage with — buyers voicing the pain you solve, not competitors — then drafts a platform-appropriate comment for each. Cookieless, BYOK, you post manually. *By [@newan2001](https://github.com/newan2001)*
