...
- [Digital Business Card Builder](https://github.com/yeshello-app/mcp/tree/main/skills/digital-business-card) - Build a complete digital business card from a website URL using YesHello MCP. Scrapes content, imports stock photos, and creates a published card with live browser editing. Supports 3 themes, 20+ field types, forms, and service listings. *By [@yeshello-app](https://github.com/yeshello-app)*
