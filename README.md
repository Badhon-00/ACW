...
- [Skillpack Forge](./skillpack-forge/) - Compiles one `skillpack.yaml` into AGENTS.md, CLAUDE.md, Claude/Codex Skills, Cursor rules, GitHub Copilot instructions, MCP resources, and MCPB bundles. *By [@guorunjie](https://github.com/guorunjie)*
