...
- [dora](https://github.com/dfbb/dora) — Community skill marketplace for AI coding agents. Query, security-filter, and load community skills on demand — no pre-installation. ~9,500-skill offline catalog with automatic platform adaptation across Claude Code, Codex, Gemini CLI, OpenCode, and Qwen Code. MIT. *By [@dfbb](https://github.com/dfbb)*
