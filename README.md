...
- [build-ready](https://github.com/jovylle/build-ready) - Scores whether a spec is ready for a zero-context AI agent to build end-to-end without asking a single question. Red-teams a PLAN/SPEC from a cold builder's seat, returns a READY/NOT READY verdict with ranked findings, and proposes concrete defaults to patch the gaps. Works in Claude Code and opencode. *By [@jovylle](https://github.com/jovylle)*
