...
- [Fable Maestro](https://github.com/zivreich/fable-maestro) - Quality-first model delegation for Claude Fable 5 sessions: Fable plans, briefs, and reviews every diff while Opus subagents write all code that lands and Sonnet handles read-only chores. *By [@zivreich](https://github.com/zivreich)*
