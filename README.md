...
- [Document to Markdown](https://github.com/oidlabs-com/Lexoid/tree/main/skills) - Parse PDFs, images, web pages, and DOCX/XLSX/PPTX into clean markdown, JSON, or LaTeX using LLM-based or static (no-API, pdfplumber/PaddleOCR) parsing with Lexoid; includes CLI and Python skills. *By [@oidlabs-com](https://github.com/oidlabs-com)*
