...
- [dev-report](https://github.com/delpicorp/dev-report) - Explains a Claude Code session in plain language: what changed, why that approach was chosen, what is still unfinished, and what to do next. Every technical term is explained at first use. *By [@delpicorp](https://github.com/delpicorp)*
