...
- [skill-receipts](https://github.com/sjh9714/skill-receipts) - Benchmark-gated skills collection: every skill must beat both a no-instruction baseline and a placebo prompt on hidden hold-out acceptance tests, or it ships as a published reject with full tables. Raw run logs are committed and the README is CI-regenerated from them. *By [@sjh9714](https://github.com/sjh9714)*
