...
- [Reelier](https://github.com/seldonframe/reelier) - Record an agent's tool-call workflow once, replay it deterministically at 0 tokens, and diff runs to catch drift — CI + snapshot tests for MCP tool-call workflows. MCP server and Agent Skill in the same repo. *By [@seldonframe](https://github.com/seldonframe)*
