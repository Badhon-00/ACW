...
- [dev-report](https://github.com/delpicorp/dev-report) - Writes up a coding session for a non-technical stakeholder, keeping the full engineering reasoning and defining every technical term at first use. *By [@delpicorp](https://github.com/delpicorp)*
