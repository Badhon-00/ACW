...
- [System of Skills](https://github.com/k-r33/best-practice-for-skill-system) - A systems-engineering methodology for organizing a collection of agent skills: stop trigger conflicts, know when to build a new skill vs merge, and verify the assembled system. Ships as an installable skill. *By [@k-r33](https://github.com/k-r33) @ [X32 Studio](https://github.com/X32Studio)*
