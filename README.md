...
- [octopus-skill](https://github.com/levi-qiao/octopus-skill) - Long-horizon agent skill for Claude Code / Cursor / Codex / Grok: durable task ledger, clean-context supervisor, verified acceptance gates. Markdown-only (loop-graph · quest arms); install as a Claude Code plugin. *By [@levi-qiao](https://github.com/levi-qiao)*
