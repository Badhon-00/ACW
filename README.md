...
- [regulex-plus](https://github.com/PipeDream941/regulex-plus) - Renders any JavaScript regex as a railroad-style SVG/PNG diagram via a Playwright-driven CLI (`npx regulex-plus '<pattern>'`). Native CJK/Chinese character support, dark/light themes, and Claude auto-invokes it for explaining, debugging, or verifying generated regexes. *By [@PipeDream941](https://github.com/PipeDream941)*
