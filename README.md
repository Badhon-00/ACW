...
- [reddit-search](https://github.com/threadsnoop/reddit-skills/tree/main/reddit-search) - Searches, filters, and ranks real Reddit posts and comments for any topic or query — monitoring, research, sentiment, or competitor mentions — judged by relevance to the actual request rather than a fixed scoring rubric. Read-only, never posts, comments, votes, or DMs. *By [@threadsnoop](https://github.com/threadsnoop)*
