...
- [globalize-skills](https://github.com/globalize-now/globalize-skills) - Makes an app multilingual: i18n setup, string extraction, and continuous translation PRs on every Git push via globalize.now. 8 skills including a dedicated Lovable path; works in Claude Code, Cursor, and Codex. *By [@globalize-now](https://github.com/globalize-now)*
