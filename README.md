...
- [Quant Data](https://github.com/celineycn/quantdata-plugin) - Market-statistics skills reporting backtested probabilities with sample sizes and p-values — day-type classification, Weis wave volume events (cib_long 51.8% over a 49.3% baseline, n=13,867), options max pain and gamma exposure — including where the methods fail. *By [@celineycn](https://github.com/celineycn)*
