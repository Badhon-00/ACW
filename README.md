...
- [okf-skills](https://github.com/scaccogatto/okf-skills) - Teaches Claude to author, maintain, validate, and visualize Open Knowledge Format (OKF) bundles: portable markdown knowledge that humans and agents both read. Includes a deterministic conformance checker, an interactive graph renderer, and a GitHub Action to gate bundles in CI. *By [@scaccogatto](https://github.com/scaccogatto)*
