...
- [Find Products by Intent](./find-products-by-intent/) - Matches outcome-focused requests to evidence-backed products from a public intent catalog, keeping sponsored placements and unsupported claims separate. [Canonical hosted version](https://mydentify.com/.well-known/agent-skills/find-products-by-intent/SKILL.md).
