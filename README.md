...
- [claude-code-cold-tester](https://github.com/gyujeongion/claude-code-cold-tester) - Runs a doc through a zero-context model to find where a real newcomer would get stuck. *By [@gyujeongion](https://github.com/gyujeongion)*
- [claude-code-council](https://github.com/gyujeongion/claude-code-council) - Claude acts as chairman, asks Gemini and GPT through your logged-in CLIs (no API keys), and reconciles their answers into one verdict. *By [@gyujeongion](https://github.com/gyujeongion)*
- [claude-code-goal-loop](https://github.com/gyujeongion/claude-code-goal-loop) - An autonomous goal loop with a verification gate each iteration, rollback snapshots, and stall detection. *By [@gyujeongion](https://github.com/gyujeongion)*
- [claude-code-request-modes](https://github.com/gyujeongion/claude-code-request-modes) - Classifies each request and turns on only the rules that apply, so one global rulebook stops bleeding into everything. *By [@gyujeongion](https://github.com/gyujeongion)*
- [claude-code-rootcause](https://github.com/gyujeongion/claude-code-rootcause) - Turns "never do X" bans into positive process gates, and audits your instruction file for ban bloat (rethink + deusex). *By [@gyujeongion](https://github.com/gyujeongion)*
- [claude-code-sandbox-gate](https://github.com/gyujeongion/claude-code-sandbox-gate) - A verification gate that runs before a change hits main, so the agent can't ship an "it works now" patch unchecked. *By [@gyujeongion](https://github.com/gyujeongion)*
