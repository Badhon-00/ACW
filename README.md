...
- [Wenlan](https://github.com/7xuanlu/wenlan/tree/main/plugin) - Claude Code plugin for a local-first AI knowledge base and LLM wiki: brief, capture, recall, handoff, and distill, backed by a local daemon and MCP. *By [@7xuanlu](https://github.com/7xuanlu)*
