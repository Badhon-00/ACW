...
- [manifest-dev](https://github.com/doodledood/manifest-dev) - Understanding-first workflow skills: /figure-out investigates the codebase before anything is built, /define encodes acceptance criteria, /do executes and verifies each criterion with an independent subagent.
