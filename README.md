...
- [Formo Analytics](https://github.com/getformo/cli/tree/main/skills/formo-analytics) - Query product and onchain analytics through [Formo](https://formo.so) MCP, CLI, or REST, including KPIs, funnels, retention, revenue, SQL, and user profiles. *By [@getformo](https://github.com/getformo)*
