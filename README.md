...
- [Pre-Flight Check](./pre-flight-check/) - A quality gate your agent runs before it calls any work done: truth checks, copy review, link verification, breakpoint-by-breakpoint visual verification with geometry-based overlap tests, and an honest delivery report. *By [@MyAiFreedomSystems](https://github.com/MyAiFreedomSystems)*
