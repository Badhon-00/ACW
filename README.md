...
- [small-council-blueprint](./small-council-blueprint/) - Forces a committed, written architecture before implementation begins, so the model never silently decides the stack file-by-file while coding. Full suite: [github.com/Nakshatra0707/small-council](https://github.com/Nakshatra0707/small-council)
- [small-council-audit](./small-council-audit/) - Runs three adversarial personas against a proposed AI architecture to find failure modes, unverified assumptions, and unnecessary complexity before you build on it.
