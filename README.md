...
- [Agentic Debugger](./agentic-debugger/) - Reproduce a bug before fixing it: parse the traceback, generate a minimal pytest repro, and verify the fix with a guarded test run. Ships zero-dependency Python stdlib scripts. *By [@whaojie797-design](https://github.com/whaojie797-design)*
