...
- [orch](https://github.com/daman8271/the-perfect-orchestrator) - Turns one Claude Code session into a fleet lead: spawns, briefs, monitors and adversarially verifies N autonomous worker sessions in tmux. Pure bash, zero daemons; also installable as a plugin. *By [@daman8271](https://github.com/daman8271)*
