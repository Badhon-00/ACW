...
- [skillreaper](https://github.com/thousandflowers/skillreaper) - 100%-local CLI that scans Claude Code session transcripts to find skills, MCP servers, and agents that load but never fire, then reversibly prunes the dead weight to reclaim context. *By [@thousandflowers](https://github.com/thousandflowers)*
