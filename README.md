...
- [dora](https://github.com/dfbb/dora) — Automatically discover and try new community skills without disrupting your workflow. Query, security-filter, and load skills on demand from a ~9,500-skill catalog with offline fallback. Cross-platform: Claude Code, Codex, Gemini CLI, OpenCode, Qwen Code. MIT. *By [@dfbb](https://github.com/dfbb)*
