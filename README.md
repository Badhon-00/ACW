...
- [ax-extract-workflow](https://github.com/Necmttn/ax/tree/main/skills/ax-extract-workflow) - Reconstructs the skill sequence and key decisions behind a shipped feature using local ax session history. *By [@Necmttn](https://github.com/Necmttn)*
