...
- [Better Harness](https://github.com/QoderAI/better-harness) - Cross-host coding-agent plugin that analyzes repository and session evidence, identifies gaps in the Agent Work Loop, and produces prioritized, verifiable improvements.
