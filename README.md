...
- [guided-tour](https://github.com/jonascript/guided-tour) - Live, interactive guided tour of any codebase — Claude as a hands-on tutor walking through how the code works one concept at a time, with real checkpoints, `file:line` citations from actually-read code, and diagrams. The conversational counterpart to walkthrough generators. *By [@jonascript](https://github.com/jonascript)*
