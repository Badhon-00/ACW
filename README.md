...
- [skill-navigator](https://github.com/GrubbyLee/skill-manager/tree/main/integrations/skill-navigator) - Recommends which already-installed local Agent Skill should handle a user task by querying the user's real skill catalog. *By [@GrubbyLee](https://github.com/GrubbyLee)*
