...
- [Find Products by Intent](https://mydentify.com/.well-known/agent-skills/find-products-by-intent/SKILL.md) - Matches outcome-focused requests to evidence-backed products from a public intent catalog, keeping sponsored placements and unsupported claims separate.
