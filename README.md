...
- [recording-knowledge](https://github.com/CCass/recording-knowledge) - Persists features, decisions, and pitfalls to project-local `docs/kb/` as AI-assisted development happens, so knowledge survives conversation boundaries. Includes three-layer questioning (WHAT→WHY→ACTUAL NEED) to avoid building the wrong thing. Install: `npx skills add https://github.com/CCass/recording-knowledge`
