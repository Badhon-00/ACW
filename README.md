...
- [Beating Resume Screeners](https://github.com/SakethKanchi/beating-resume-screeners) - Audits and optimizes a resume against automated LLM resume-screening agents, reproducing the 120-point rubric reverse-engineered from HackerRank's open-source hiring-agent. Includes a stdlib-only script that replays the agent's live GitHub repo classification so you see what caps your score, and recommends only honest, real fixes. *By [@SakethKanchi](https://github.com/SakethKanchi)*
