...
- [overhaul-ui](https://github.com/ShadowFull12/overhaul-ui) - Frontend design skill that detects and defers to specialist skills (animation, anti-slop, color), with WCAG 2.2 guidance, OKLCH, and 35-rule slop-detection scripts. *By [@ShadowFull12](https://github.com/ShadowFull12)*
