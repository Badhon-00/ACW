...
- [quit-sponsor](https://github.com/metrox-eth/quit-sponsor) - Turns an AI agent with persistent memory into a quit-smoking sponsor: evidence-based cessation protocols (44 cited sources) plus a sponsor decision tree, in the open Agent Skills (SKILL.md) standard. MIT licensed. *By [@metrox-eth](https://github.com/metrox-eth)*
