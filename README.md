...
- [Halal App Check](https://github.com/kyota8ai/halal-app-check) - Screens an app for Islamic (Shariah) compliance across six layers — purpose, monetization, UX, data handling, company finances, supply chain — with sourced fatwa citations, category deep-dives (fintech, games, social, Quran apps), and PASS / FIX / ASK-A-SCHOLAR verdicts per layer. *By [@kyota8ai](https://github.com/kyota8ai)*
