...
- [brents-toasts](https://github.com/brentspine/brents-toasts/tree/main/docs) - Write correct code against brents-toasts, a zero-dependency toast/snackbar UI library: call shapes, buttons, details, timers, progress bars, theming, localization, and the plain-text vs `allowHtml` XSS rule. *By [@brentspine](https://github.com/brentspine)*
