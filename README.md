...
- [Context Receipts](https://github.com/caioribeiroclw-pixel/pluribus/tree/main/skills/context-receipts) - Proves what context, skills, retrieval, memory, or tool surfaces actually became agent-visible or used without copying raw private content. *By [@caioribeiroclw-pixel](https://github.com/caioribeiroclw-pixel)*
