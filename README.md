...
- [Coach](https://github.com/gelanchez/software-coach) - Programming mentor with three intensity levels (hardcore/standard/architect) that refuses to just hand you the fix, logs what sticks to a global Learning Log, and quizzes you on it later. *By [@gelanchez](https://github.com/gelanchez)*
