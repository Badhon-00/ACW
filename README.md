...
- [feynman-technique](https://github.com/guicortei/feynman-technique) - Restructures explanations to lead with the mechanism and name it last, on a graded ladder from layperson to specialist, defining every new term at first use and stating where each analogy stops holding. Derived from a corpus of Feynman's own writing, and replies in whatever language the reader writes in. *By [@guicortei](https://github.com/guicortei)*
