...
- [email-pro-max](https://github.com/jayesh-bansal/email-pro-max) - HTML email design intelligence: bulletproof Outlook/Gmail/Apple Mail rendering, VML buttons, dark mode, and a CSS support matrix for 25+ clients. *By [@jayesh-bansal](https://github.com/jayesh-bansal)*
