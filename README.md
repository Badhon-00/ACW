...
- [deterministic-design](https://github.com/connerkward/deterministic-design-skill) - Renders your UI and proves it's balanced and usable: a deterministic layout audit (overflow, spacing, alignment, contrast) plus a vision-model usability pass. *By [@connerkward](https://github.com/connerkward)*
...
- [lookdev](https://github.com/connerkward/lookdev-studio-skill) - Stands up a live, human-in-the-loop web studio with sliders and pickers to tune AI-generated visual output by eye, then bakes reproducible assets instead of guessing values. *By [@connerkward](https://github.com/connerkward)*
- [screenstudio-alternative](https://github.com/connerkward/screenstudio-alternative-skill) - Open-source, headless Screen Studio alternative for polishing screen recordings: auto-zoom on clicks, idle speed-up, keystroke overlays, smoothed cursor, and vertical social export. *By [@connerkward](https://github.com/connerkward)*
