...
- [planning-with-files](https://github.com/OthmanAdi/planning-with-files) - Manus-style persistent markdown planning for coding agents: task_plan.md, findings.md, and progress.md survive context loss, /clear, and session death, with automatic session recovery, hash-attested plan injection, and an opt-in completion gate. Works across Claude Code, Codex CLI, Cursor, and 70+ SKILL.md agents. *By [@OthmanAdi](https://github.com/OthmanAdi)*
