...
- [Math.skill](https://github.com/Wholiver/Math.Skill) - Rigorous mathematical reasoning for AI agents: covers 30+ domains from arithmetic to abstract algebra with step-by-step derivation and multi-method verification. *By [@Wholiver](https://github.com/Wholiver)*
