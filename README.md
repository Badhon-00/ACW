...
- [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) - 21-skill pack for Claude Code and Codex covering music creator workflows: Rights Passport, Campaign in a Box, provenance mapping, royalty routing, Suedify website restyling, SEO/AEO/AI EO audits, A-F code grading, design QA, and agent commerce prep. MIT licensed. *By [@JasonColapietro](https://github.com/JasonColapietro)*
