...
- [SuperSpec](https://github.com/lbk-open/super-spec) - Combines superpowers-style engineering discipline with OpenSpec-style living specs, and adds end-to-end workflows that carry a requirement, or a production alert, to a reviewed pull request, plus multi-repo orchestration. Implementation is dispatched to parallel TDD subagents; a review panel then returns a severity-graded verdict and drives a bounded fix loop. *By [@lbk-open](https://github.com/lbk-open)*
