...
- [humanizer](https://github.com/Aboudjem/humanizer-skill) - Detects 53 AI-writing patterns and rewrites text for burstiness and voice, with 5 voice profiles, a 0-100 AI-tell score, detect/rewrite/edit modes, and an optional metrics CLI plus CI quality-gate. *By [@Aboudjem](https://github.com/Aboudjem)*
