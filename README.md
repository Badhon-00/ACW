...
- [skill-forge](https://github.com/DENGYUFAN0/skill-forge) - Closed-loop, low-cost skill-tuning pipeline: a cheap model mass-generates adversarial evals, a capable model surgically tunes the skill. *By [@DENGYUFAN0](https://github.com/DENGYUFAN0)*
