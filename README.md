...
- [my-refactor](https://github.com/Zahrannnn/my-refactor) - Refactor React frontends into feature-first architecture, modularizing monoliths into cohesive feature modules by user/domain capability. *By [@Zahrannnn](https://github.com/Zahrannnn)*
