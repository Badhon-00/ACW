...
- [dynamsoft-sdk](https://github.com/yushulx/dynamsoft-sdk-skill) - Generates and reviews accurate code for Dynamsoft SDKs (Barcode Reader, Capture Vision, Web TWAIN, Document Viewer) across web, mobile, server, and desktop, with a bundled DBR template-optimizer sub-skill for barcode decode-rate tuning. *By [@yushulx](https://github.com/yushulx)*
