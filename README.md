...
- [doaipm](https://github.com/zhitongblog/doaipm-skill) - The DO AI PM method for building products as a product manager in the AI era: turn an idea into a real, runnable prototype by describing intent. Speak it and AI builds it; high-fidelity first; five-phase workflow (Discover → Define → Design → Develop → Validate) under one safety net. Works with Claude Code, Codex, Cursor, and Gemini CLI. *By [@zhitongblog](https://github.com/zhitongblog)*
