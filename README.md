...
- [cowork-to-code-bridge](https://github.com/abhinaykrupa/cowork-to-code-bridge) - Runs tasks on your own Mac or Linux box from a Claude Cowork session — builds, tests, git push, brew/npm/pip installs. A local daemon watches a shared directory and hands work to Claude Code on the machine, so sandboxed sessions can reach localhost and real hardware without a VPS or webhooks. *By [@abhinaykrupa](https://github.com/abhinaykrupa)*
