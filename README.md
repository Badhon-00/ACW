...
- [Video Production Router](./video-production-router/) - Routes a video brief to generation, designed composition, supplied-footage editing, or a mixed workflow. Inspired by [OrkasVideoStudio](https://github.com/Orkas-AI/Orkas-VideoStudio).
