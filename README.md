...
- [OpenSource Review Suite](https://github.com/priyank766/OpenSource-SKILL) - Eight detection-first skills for reviewing open-source pull requests — security, dependencies, API compatibility, tests, performance, docs, and contributor experience — with a weighted 10-point filter that cuts each review down to the two or three findings worth a comment. *By [@priyank766](https://github.com/priyank766)*
