...
- [pdf-to-markdown-skill](https://github.com/zhijun-dai/pdf-to-markdown-skill) - Converts text-based PDFs into clean, AI-friendly Markdown with image extraction, scan-page detection, and a conversion report.
