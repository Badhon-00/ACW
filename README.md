...
- [SnapTidy](https://github.com/chicogong/snaptidy) - AI-powered photo organizer for macOS. Deduplicate via pHash/ML vectors, cross-format detection (HEIC/JPEG), EXIF fix, natural-language conversation.
