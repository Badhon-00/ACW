...
- [skill-advisor](https://github.com/Dcrr1717/skill-advisor) - Scans every installed skill (personal + plugins), reasons phase-by-phase about which ones fit your project, and delivers a max-8 recommendation table, workflow, and ready-to-paste prompt - honestly reporting gaps your catalog doesn't cover. *By [@Dcrr1717](https://github.com/Dcrr1717)*
