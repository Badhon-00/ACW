...
- [desrobotizar](https://github.com/mszsorondo/desrobotizar) - Remove Spanish AI slop from prose: strips machine-writing patterns specific to Spanish (chained gerunds, reflexive passive, -mente adverbs) and learns your personal writing style from your own texts. *By [@mszsorondo](https://github.com/mszsorondo)*
