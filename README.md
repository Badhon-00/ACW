...
- [Evidentia](https://github.com/kgraph57/evidentia) - Catch AI-fabricated medical citations before you publish. Verifies DOIs/PMIDs against CrossRef/PubMed/OpenAlex (4-tier classification) + a 15-criteria evidence-appraisal skill. CLI + MCP + Claude Code plugin. Built by a pediatrician. *By [@kgraph57](https://github.com/kgraph57)*
