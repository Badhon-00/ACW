...
- [master-skill (大师.skill)](https://github.com/swaylq/master-skill) - Meta-skill that distills an entire industry's cognitive OS into a loadable skill: name a niche, it runs 6-track research and generates mental models, decision rules, workflows plus a bash CLI suite, with 16 automated quality checks. Bilingual (EN+中文), 72 end-to-end industry samples included. *By [@swaylq](https://github.com/swaylq)*
...
- [sijiao-skill (私教.skill)](https://github.com/swaylq/sijiao-skill) - Meta-skill that distills any skill you want to learn into a stateful private tutor: 8-track research → learning-science curriculum (prerequisite DAG, deliberate practice, SM-2 spaced repetition) → a tutor that remembers your progress and adapts its exercises to your level. Bilingual (EN+中文), 6 end-to-end samples. *By [@swaylq](https://github.com/swaylq)*
