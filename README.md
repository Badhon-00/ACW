...
- [Moltline Skills](https://github.com/GarphenGate/moltline-oss) - 138 free skills in one MIT-licensed pack, covering business operations, education, creative work, developer tooling and personal productivity. Every skill is a single SKILL.md with an explicit scope, a `## Rules` section stating what it will not do, and a defined output format. *By [@GarphenGate](https://github.com/GarphenGate)*
