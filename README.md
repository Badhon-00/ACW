...
- [d2-diagrams](https://github.com/khollingworth/d2-diagram-skill) - Renders professional D2 architecture diagrams (TALA/ELK) as SVG with a self-checking render loop: the agent views its own render and fixes layout defects before delivering. *By [@khollingworth](https://github.com/khollingworth)*
