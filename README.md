...
- [Feynman It](https://github.com/TadTheFisherman/feynman-it) - Turns any topic into a hand-illustrated PDF using the Feynman technique -- plain language, an analogy diagram, and named misconceptions. *By [@TadTheFisherman](https://github.com/TadTheFisherman)*
