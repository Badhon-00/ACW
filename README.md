...
- [humanizer-skills](https://github.com/codingrajan/humanizer-skills) - Four register-aware humanizer skills (general, academic, legal, social/blog) sharing one 44-pattern catalog with register-tuned rewrite rules. Includes a developer-writing pattern set for READMEs, docs, and comments. *By [@codingrajan](https://github.com/codingrajan)*
