...
- [ros2-sim-skill](https://github.com/BaraaLazkani/ros2-sim-skill) - ROS2 Jazzy + Gazebo Harmonic simulation skill that builds, runs, verifies, and visualizes robot simulations end to end — URDF/xacro, ros_gz bridge, RViz, and evidence-based verification. *By [@BaraaLazkani](https://github.com/BaraaLazkani)*
