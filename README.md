...
- [SkillAlchemy](https://github.com/agentsope/SkillAlchemy) - Meta-skill that distills any person, methodology, or experience into an installable skill. Fuses multiple skills into new composite capabilities and supports self-directed learning path selection. Install via `npx skills add agentsope/SkillAlchemy`. *By [@agentsope](https://github.com/agentsope)*
