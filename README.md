...
- [project-planning-journaling](https://github.com/mh-mansouri/Project-Planning-Journaling) - Scopes a project (type, repo, timeline, public vs. private-product path, dev style) before any code is written, then sets up and maintains a living, resumable documentation journal with a weekly routine review. _By [@mh-mansouri](https://github.com/mh-mansouri)_
