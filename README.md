...
- [collab-proof](https://github.com/dong7812/collab-proof) - Infers AI collaboration evidence from development sessions: runs a Vela 3-layer signal pipeline × ADHD 4-frame analysis to capture decisions, alternatives, and exact AI contribution — then exports a self-contained HTML proof artifact. Zero external dependencies. *By [@dong7812](https://github.com/dong7812)*
