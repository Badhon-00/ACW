...
- [enterprise-architecture](https://github.com/gauravs19/enterprise-architecture-skill) - Unified enterprise & software architecture skill: C4 + Structurizr DSL, ArchiMate, TOGAF ADM, and arc42 + ADRs. Diagrams-as-code, ADRs, architecture reviews, and capability→app→tech maps. *By [@gauravs19](https://github.com/gauravs19)*
