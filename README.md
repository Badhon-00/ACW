...
- [Substack Toolkit](./substack-toolkit/) - Drafts rich Substack posts from Markdown or Python, with image upload that works around the three undocumented private-API gotchas (rawHtml editor-crash, base64-only image upload, null bylines on draft PUT). *By [@mphinance](https://github.com/mphinance)*
