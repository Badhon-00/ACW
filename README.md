...
- [kc_ai_skills](https://github.com/KerberosClaw/kc_ai_skills) - A Traditional Chinese-first collection of 22 reusable agent skills with bilingual documentation for Claude Code and Codex, including engineering-discipline workflows for requirements grilling, reproducible debugging, ADRs, and spec-driven delivery. *By [@KerberosClaw](https://github.com/KerberosClaw)*
