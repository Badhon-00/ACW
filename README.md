...
- [agent-skill-groups](https://github.com/go165/agent-skill-groups) - Switch local Agent Skills by runtime and scenario for Codex, Claude Code, OpenCode, and generic SKILL.md folders. *By [@go165](https://github.com/go165)*
