...
- [CLAUDE.md Auditor](https://github.com/novadyne-hq/claudemd-auditor-skill) - Audits your CLAUDE.md file with calibrated 0–100 scoring across 6 axes (structure, specificity, safety, and more) and concrete fixes for each finding. Drop-in Claude Code skill. *By [@infai-tech](https://github.com/infai-tech)*
