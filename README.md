...
- [engram-mcp](https://github.com/lalithbuilds/engram-mcp) - Zero-dependency, pure Python stdlib MCP server for persistent AI agent memory via SQLite FTS5. Auto-initializing and fully local. *By [@lalithbuilds](https://github.com/lalithbuilds)*
