...
- [MiniMax Video Generator](https://github.com/octo-patch/awesome-claude-skills/tree/0eafac95e6d7817c47998fe8bf11848cac6ae3eb/minimax-video-generator) - Generates videos from text prompts or a first-frame image using the MiniMax video generation API, with MiniMax-H3 v2 support, task listing and deletion, model selection, global and China regions, asynchronous status polling, and local download.
