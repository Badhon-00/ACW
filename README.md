...
- [claude-nuxt-fullstack-scaffold](https://github.com/rga-rt/claude-nuxt-fullstack-scaffold) - Scaffold production-ready Nuxt 3 apps with Tailwind, Vitest, and optional i18n, SQLite (Drizzle), or Supabase; installable as a Claude Code plugin. *By [@rga-rt](https://github.com/rga-rt)*
