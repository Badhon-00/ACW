...
- [same-frame](https://github.com/sjh9714/same-frame) - Re-render an image with Krea 2 without moving the composition: relight, recolour, or change the medium. Every recipe records the strength and seed that produced its example and the unrelated source it was re-tested on, and the two edits it cannot do are refused with the failed run cited. *By [@sjh9714](https://github.com/sjh9714)*
