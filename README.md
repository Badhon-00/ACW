...
- [UI Review](https://github.com/roney492/ui-review) - Automated UI/UX review via the agent-browser CLI: text overflow, wrapping, responsiveness across breakpoints, dark mode, WCAG zoom/reflow, codebase-mapped fixes, and a token-saving baseline/diff regression mode. *By [@roney492](https://github.com/roney492)*
