...
- [Context Kit](https://github.com/JDDavenport/context-kit) - Personal Context Artifacts: 4 Markdown templates + 5 Claude Code skills for persistent session context. Start every AI session context-full, not context-zero. MIT, one-command install.
