...
- [skillscope](https://github.com/kabylesystem/skillscope) - Local dashboard for your whole skill bank: lists every skill on your machine (global, per-project, plugins), mines real usage from Claude Code transcripts, and flags duplicates, dead references and never-used skills.
