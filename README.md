...
- [Swift Ship](https://github.com/chsistrying/swift-ship-skills) - Five skills that take a Swift/macOS app from "builds on my machine" to a public GitHub release: .icns icon generation, SwiftPM .app/DMG packaging, CI portability traps, open-source readiness audit, and end-to-end release flow. *By [@chsistrying](https://github.com/chsistrying)*
