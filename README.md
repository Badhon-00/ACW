...
- [paper-skills](https://github.com/whoisraibolt/paper-skills) - Deep pre-submission review and grounded drafting for scientific manuscripts, on Google's Paper Assistant Tool architecture. Every finding carries a literal quote and states what would make it wrong; Stage 3.5 thresholds are calibrated against 76 human articles, not asserted. *By [@whoisraibolt](https://github.com/whoisraibolt)*
