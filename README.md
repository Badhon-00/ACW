...
- [Pluribus Skill Policy Receipts](./pluribus-skill-policy-receipts/) - Emit privacy-safe receipts proving hard Skill rules were allowed, refused, or guarded before writes. *By [@caioribeiroclw-pixel](https://github.com/caioribeiroclw-pixel)*
