...
- [Submit to agentlaunch](./submit-to-agentlaunch/) - Lists, launches, or registers an AI agent on agentlaunch (a Product Hunt-style directory for agents) and upvotes agents via a public, no-auth REST API. Self-corrects from the API's validation errors. *By [@berset](https://github.com/berset)*
