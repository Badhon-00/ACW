...
- [small-council-blueprint](https://github.com/Nakshatra0707/small-council/blob/main/skills/small-council-blueprint/SKILL.md) - Forces a committed, written architecture before implementation begins, so the model never silently decides the stack file-by-file while coding. Full suite: [github.com/Nakshatra0707/small-council](https://github.com/Nakshatra0707/small-council)
