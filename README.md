...
- [game-build-team](https://github.com/Varalix-Digitech-Solutions/game-build-team-skill) - Multi-agent team (Manager, Creative Director, Logic & Animation Developers, Tester) that builds Godot 4 / GDScript game features behind two unskippable gates — a rapid headless test gate and an "is it fun" creative gate — capped by an on-device final pass. Deterministic build/test loop; pausable/resumable. *By [@Venugopal-Chavate](https://github.com/Venugopal-Chavate)*
