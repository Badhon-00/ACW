...
- [production-architecture-guardian](https://github.com/dankofly/production-architecture-guardian) - Audits and designs production-grade architecture (scalability, security, reliability, data, supply chain) with two hard rules: no invented configuration numbers and no unlabeled claims - every value needs a source, measurement, or business requirement. *By [@dankofly](https://github.com/dankofly)*
