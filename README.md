...
- [evidence-before-claims-verifier](https://github.com/ilan-moatty/evidence-before-claims-verifier) - Forces fresh on-disk evidence logs before completion claims at commit/PR/release gates. Three resolution fallbacks (package.json/justfile/Makefile), red-green ritual for bug fixes, stale detection via files_hash. *By [@ilan-moatty](https://github.com/ilan-moatty)*
