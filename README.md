...
- [obsidian-brain-eval](https://github.com/build-with-dhiraj/obsidian-brain-eval) - Generate a gold Q&A set from your Obsidian vault and measure Recall@10 (BM25 or LanceDB) to see if your second brain can actually retrieve what you know. *By [@build-with-dhiraj](https://github.com/build-with-dhiraj)*
- [obsidian-graph-auditor](https://github.com/build-with-dhiraj/obsidian-graph-auditor) - Score your Obsidian graph health on an 8-dimension PKM rubric (orphan rate, link density, hub concentration, Louvain modularity) and gate it in CI. Deterministic, read-only, JSON output. *By [@build-with-dhiraj](https://github.com/build-with-dhiraj)*
- [obsidian-orphan-killer](https://github.com/build-with-dhiraj/obsidian-orphan-killer) - Fix orphan notes in Obsidian: resolve plain-text mentions to wikilinks deterministically, anchor orphans via embeddings, and mint cluster hubs. 12 safety guards, frontmatter-only edits, idempotent. *By [@build-with-dhiraj](https://github.com/build-with-dhiraj)*
