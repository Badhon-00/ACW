...
- [seudesign](https://github.com/SeuPut0705/seudesign) - Executable system design skill: generates design docs with capacity math and mermaid diagrams, audits codebase architecture as file:line findings, runs rubric-scored mock interviews, and estimates capacity. 22 worked case studies, 13 references, bundled read-only reviewer agent. *By [@SeuPut0705](https://github.com/SeuPut0705)*
