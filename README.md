...
- [EGC](https://github.com/Fmarzochi/EGC) - Persistent cross-session memory MCP server for Claude Code and 12 other AI coding tools. SQLite-backed state survives context resets. Install with `npm install -g @egchq/egc`. *By [@Fmarzochi](https://github.com/Fmarzochi)*
