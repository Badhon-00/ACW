...
- [klarsprak](https://github.com/pattespatte/klarsprak-skill) - Reviews and rewrites Swedish text using klarspråk (Swedish plain language) principles from Isof, with automated fact checking that keeps numbers, dates, and URLs intact. *By [@pattespatte](https://github.com/pattespatte)*
