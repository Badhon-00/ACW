...
- [Kudosity Messaging](https://github.com/kudosity/skills) - Send SMS, MMS, WhatsApp and RCS from your agent via the Kudosity API. Eight skills covering setup, each channel, contact lists and delivery webhooks — including the platform rules agents reliably get wrong, like WhatsApp’s 24-hour service window and RCS sending through a registered agent ID rather than a phone number. *By [@kudosity](https://github.com/kudosity)*
