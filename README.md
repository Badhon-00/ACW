...
- [deep-verify](https://github.com/Xander-26Code/deep-verify) - Adversarial code verification that catches AI-generated bugs — the "almost right" code that passes review but fails in production. *By [@Xander-26Code](https://github.com/Xander-26Code)*
