...
- [Robot Actions Real-Device Testing](https://github.com/krishtoautomate/robotactions/tree/main/skills) - Drives real Android and iOS devices and desktop browsers for mobile and web QA. Covers locating elements without guessing coordinates from a screenshot, asserting against the device rather than assuming, and recording replayable regression flows. Install with `npx skills add krishtoautomate/robotactions`. *By [@krishtoautomate](https://github.com/krishtoautomate)*
