...
- [mailtrap-skills](https://github.com/mailtrap/mailtrap-skills) - Agent skills for Mailtrap covering email sending, sandbox testing, domain setup, and contacts management.
