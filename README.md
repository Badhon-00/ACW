...
- [human-comments](https://github.com/roeibh/human-comments) - Makes Claude write short, human code comments: deletes AI verbosity and keeps only the non-obvious *why* the code can't say. Works in any coding agent. *By [@roeibh](https://github.com/roeibh)*
