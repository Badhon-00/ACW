...
- [iterate-skill](https://github.com/jingzhao-l/iterate-skill) - Fully automated multi-round code iteration with configurable N-dimension parallel review for AI programming agents. Enables structured iterative development with built-in safety checks, code review automation, and incremental delivery. *By [@jingzhao-l](https://github.com/jingzhao-l/iterate-skill)*
