...
- [loom](https://github.com/wess/loom) - Package manager for AI skills that installs, inspects, and authors reusable skills for Claude Code, Codex, Cursor, and any agent that loads a skills folder, with Homebrew-style manifests and repositories. *By [@wess](https://github.com/wess)*
