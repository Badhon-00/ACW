...
- [skill-manager](https://github.com/potocibi/skills-manager) - Audits, deduplicates, and merges your installed skills — clusters overlapping skills by job, keeps one canonical each, routes tasks to the right one, and gates new installs against what you already have. Never deletes (undo manifest).
