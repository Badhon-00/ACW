...
- [human-html](https://github.com/rhnfzl/human-html) - Turn plans, reviews, architecture explainers, and postmortems into validated single-file HTML review surfaces humans actually read; ships an offline validator, auto-generated gallery, agent hooks, and optional S3 publishing. *By [@rhnfzl](https://github.com/rhnfzl)*
