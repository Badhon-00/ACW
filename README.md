...
- [exgram](https://github.com/mamadoudicko/exgram) - Turns a natural-language prompt or a screenshot into a live, editable Excalidraw board: architecture diagrams, flowcharts, database/ER schemas, state machines, sequence diagrams, and mind maps. Renders locally and auto-refreshes as you refine by chatting, then exports to .excalidraw, PNG, or SVG. No API key. *By [@mamadoudicko](https://github.com/mamadoudicko)*
