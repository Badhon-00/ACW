...
- [klibs.io Search](https://github.com/Wavesonics/klibs-skill) - Search klibs.io for Kotlin / Kotlin Multiplatform libraries from natural-language descriptions. Returns name, version, license, and supported KMP platforms (androidJvm, common, js, jvm, native, wasm). *By [@Wavesonics](https://github.com/Wavesonics)*
