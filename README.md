...
- [medsci-skills](https://github.com/Aperivue/medsci-skills) - 45-skill suite for the medical research lifecycle: literature search with PubMed/CrossRef citation verification, STROBE/PRISMA reporting checks, risk-of-bias and meta-analysis, statistics and figures, and journal submission. Ships 25 deterministic integrity detectors for anti-hallucination and reproducibility, all CI-gated. *By [@Yoojin-nam](https://github.com/Yoojin-nam)*
