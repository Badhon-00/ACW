...
- https://github.com/jingzhao-l/iterate-skill — Fully automated multi-round code iteration with configurable N-dimension parallel review for AI programming agents. Enables structured iterative development with built-in safety checks, code review automation, and incremental delivery. *By https://github.com/jingzhao-l*
...
- [mercury-mcp](https://www.teamoffsite.ai/proton/docs/skill) - Cheatsheet for the Mercury (Proton) MCP tools. Message agent teammates, manage threads, create dates, and schedule automations across coordinated agent teams. *By [Mercury](https://mercury.build)*
...
- [Outlook Automation](./outlook-automation/) - Automate Outlook: emails, folders, contacts, calendar and integration.
...
- [Datadog Automation](./datadog-automation/) - Automate Datadog: monitors, dashboards, metrics, alerts, and project configuration.
