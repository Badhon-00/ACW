...
- [UIZZE anti-ui-slop](https://github.com/uizze/uizze/tree/main/skills/anti-ui-slop) - Stop generic UI before it ships with an agent-agnostic workflow grounded in 800,000+ real web and iOS screens, product-specific design contracts, required states, and a hard finish gate.
