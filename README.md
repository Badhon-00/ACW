...
- [Fact-Check-X](https://github.com/ASI2030/Fact-Check-X/tree/main/skills/fact-check-x-complete) - Captures complete answers and citations from one or more AI platforms, compares atomic claims, verifies them against authoritative evidence, and produces traceable stage reports. *By [@ASI2030](https://github.com/ASI2030)*
