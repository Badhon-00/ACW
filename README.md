...
- [CheckYourself](./checkyourself/) - Runs read-only production-readiness diagnostics for AI-built apps with evidence-backed scoring, complete findings, safest-first fixes, and learning plans. *By [@simongonzalezdc](https://github.com/simongonzalezdc)*
