...
- [awesome-mental-models](https://github.com/machinarii/awesome-mental-models) - Library of 249 mental models plus a skill that interviews you, picks the right framework for your situation, and facilitates a working session through it instead of lecturing. *By [@machinarii](https://github.com/machinarii)*
