...
- [skill-to-web-prompt](https://github.com/Ww-Cooooo/skill-to-web-prompt) - Converts Claude Code skills into self-contained prompts for web AI tools (DeepSeek, ChatGPT, Doubao) with honest fidelity analysis. *By [@Ww-Cooooo](https://github.com/Ww-Cooooo)*
