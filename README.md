...
- [unbrowser](https://github.com/protostatis/unbrowser) - Uses a lightweight local MCP browser for JavaScript-capable web access before escalating to Playwright or real Chrome.
