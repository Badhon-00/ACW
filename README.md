...
- [pilot-skills](https://github.com/TeoSlayer/pilot-skills) - Agent skills for Pilot Protocol, an overlay network that gives agents a permanent address, encrypted P2P tunnels, and per-peer trust. Skills cover direct agent-to-agent messaging, file transfer, trust/handshake management, and swarm/task coordination over the network. *By [@TeoSlayer](https://github.com/TeoSlayer)*
