...
- [travel-map-animator](https://github.com/B0LLEX/travel-map-animator) - CLI that renders Jet Lag-style animated travel-route videos (MP4, 1920×1080) from coordinates — real road routes via OSRM and real rail geometry from OpenStreetMap, drawn progressively over a desaturated OSM basemap, encoded locally with ffmpeg. Ships as a Claude Code skill. *By [@B0LLEX](https://github.com/B0LLEX)*
