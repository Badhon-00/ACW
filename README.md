...
- [optim-agent](https://github.com/Optim-Agent/optim-agent) - Optimize configurable systems against measurable objectives with coding-agent-guided trials. *By [@Optim-Agent](https://github.com/Optim-Agent)*
