...
- [lastmemory](https://github.com/uxKero/lastmemory) - Persistent, context-efficient memory for coding projects: a network of linked markdown files anchored to repo zones, with layered loading, active forgetting via a "dream" consolidation pass, and a self-contained offline HTML graph with keyword search. *By [@uxKero](https://github.com/uxKero)*
