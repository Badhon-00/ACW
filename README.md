...
- [jsonld-knowledge-graph](https://github.com/shimo4228/jsonld-knowledge-graph) - Designs and ships a companion JSON-LD knowledge graph next to llms.txt, encoding domain entities and relationships as schema.org triples for LLM citation. *By [@shimo4228](https://github.com/shimo4228)*
- [llms-txt-writer](https://github.com/shimo4228/llms-txt-writer) - Writes AI-facing documents (llms.txt, FAQ, glossary) optimized for citation by ChatGPT, Perplexity, and Gemini, following the Answer.AI llms.txt standard. *By [@shimo4228](https://github.com/shimo4228)*
...
- [context-sync](https://github.com/shimo4228/context-sync) - Audits and fixes project documentation role overlaps — one command to keep CLAUDE.md, CODEMAPS, ADRs, and README healthy. *By [@shimo4228](https://github.com/shimo4228)*
