...
- [Multi-Source Search](https://github.com/sandbaseai/sandbase-skills/tree/main/research/multi-source-search) - Researches a topic across current web, semantic, academic, and broad-search sources, then reports agreements, disagreements, confidence levels, and evidence gaps. *By [@sandbaseai](https://github.com/sandbaseai)*
