...
- [ForgeDock](https://github.com/RapierCraftStudios/ForgeDock) - Autonomous AI development pipeline — 20+ slash commands for investigation, building, review, and merge workflows using GitHub as a structured knowledge graph for Claude Code agents. *By [@RapierCraftStudios](https://github.com/RapierCraftStudios)*
