...
- [Context Receipts](https://github.com/caioribeiroclw-pixel/pluribus/tree/main/examples/agent-skills/context-receipts) - Emit privacy-safe receipts for context selection, deferral, hydration, compaction, pruning, delegation, usage attribution, and boundary handoffs. *By [@caioribeiroclw-pixel](https://github.com/caioribeiroclw-pixel)*
