...
- [seoagent](https://github.com/Baxter-Inc/seoagent-npm) - Persistent AI SEO agent for Claude Code: runs technical audits, builds hub-and-spoke keyword strategy, writes page-type-aware briefs and SEO-optimized articles, and saves everything to a .seoagent/ workspace that persists across sessions. Installs via npm or the plugin marketplace. *By [@Baxter-Inc](https://github.com/Baxter-Inc)*
