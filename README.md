...
- [omnireach](https://github.com/Daily-AC/omnireach) - Multi-source web search for AI agents: one CLI + Claude Code skill that searches and reads WeChat official accounts, Xiaohongshu, Douyin, Bilibili, Twitter, Reddit, YouTube, and Hacker News through the user's own logged-in browser sessions, returning one uniform JSON schema. *By [@Daily-AC](https://github.com/Daily-AC)*
