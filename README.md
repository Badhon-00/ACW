...
- [fable-mode](https://github.com/fabdelgado/fable-mode) - Clones Claude Fable 5's reasoning habits — plan-first, self-refutation, verification loops, scope discipline — as an installable skill for any model. A/B validated against native Fable outputs (20/20 convergence, blind-judge preference parity). *By [@fabdelgado](https://github.com/fabdelgado)*
