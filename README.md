...
- [Mac Cleanup](https://github.com/sai-na/claude-mac-cleanup) - Safely reclaims disk space and RAM on Apple Silicon macOS for developers and creative pros, scanning first and confirming before deleting dev-tool and creative-app caches. *By [@sai-na](https://github.com/sai-na)*
