...
- [content-multiplier](https://github.com/CadenceStandard/content-multiplier) - Turn one idea into a week of platform-native content: X thread, LinkedIn post, short-form script, carousel, newsletter, blog outline, YouTube hooks, and quote-cards — each in that platform's native shape. *By [@CadenceStandard](https://github.com/CadenceStandard)*
