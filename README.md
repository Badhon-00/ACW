...
- [Claude Code Eyes](https://github.com/fcavalcantirj/claude-code-eyes) - Lets Claude see real hardware, displays, and wiring through a camera: visually verify a rendered panel (catching what no unit test can) or check wiring and voltage rails before power-on. *By [@fcavalcantirj](https://github.com/fcavalcantirj)*
