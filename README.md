...
- [spec-create](https://github.com/benjaminthomas/spec-driven-dev/tree/main/skills/spec-create) - Turns a planning conversation into a spec folder of self-contained, dependency-ordered task files grouped into parallel batches; first stage of a 5-skill pipeline (spec-create → spec-implement → spec-verify → spec-checkpoint → spec-ship). *By [@benjaminthomas](https://github.com/benjaminthomas)*
