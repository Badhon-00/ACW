...
- [FutureSearch SDK](https://github.com/futuresearch/futuresearch-python/tree/main/skills/futuresearch-python) - Run AI web research agents across
  table rows in parallel and synthesize multi-agent findings into structured columns. *By [@futuresearch](https://github.com/futuresearch)*
