...
- [software-graph-analysis](./software-graph-analysis/) - Uses Ontoly to build or query a deterministic Software Graph before source search for architecture summaries, route tracing, dependency analysis, configuration usage, and impact analysis.
