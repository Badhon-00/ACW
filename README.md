...
- [qa-agent-skill](https://github.com/amalshehu/qa-agent-skill) - Turns Claude into an autonomous QA tester for a running web app: explores like a confused/adversarial user, verifies findings independently, and files bugs as GitHub issues or Jira tickets with repro GIFs. *By [@amalshehu](https://github.com/amalshehu)*
