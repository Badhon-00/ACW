...
- [loop-engineering](https://github.com/qingqingpi/loop-engineering-skill) - Design, evaluate, diagnose, and harden repeated or unattended AI-agent loops (maker-checker, queue-processing, multi-agent) around verifier fidelity and a GREEN/YELLOW/RED task-fit triage. Ships a reproducible cross-model eval. *By [@qingqingpi](https://github.com/qingqingpi)*
