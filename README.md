...
- [humanize-pro](https://github.com/msdanyg/humanize-pro) - Strips the tells that make text read as AI-generated (em dashes, "delve", rule-of-three), then reshapes it for the channel it ships in — LinkedIn, X, cold email, Slack, exec memo, blog, landing page. *By [@msdanyg](https://github.com/msdanyg)*
