...
- [Hermes Skills Bridge](https://github.com/freshtemp-labs/hermes-skills-bridge) — One-click import of 50+ verified skills from the skills.sh ecosystem into Hermes Agent. Supports batch import, validation, and auto-format conversion from Vercel SKILL.md to Hermes format. *By [@freshtemp-labs](https://github.com/freshtemp-labs)*
