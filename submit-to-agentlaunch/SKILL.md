...
description: Submit an AI agent to agentlaunch and upvote agents via the public REST API. Use when the user wants to list, launch, publish, or register an agent on agentlaunch, or programmatically vote on one. No auth, no signup, no API key.
---
